...
const Navbar = () => {
  ...
  return (
    <div className="bg-black w-full">
        ...
        <div className={!nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-600 bg-[#000300] text-white ease-in-out duration-500 lg:hidden' : ' fixed left-[-100%]'}>
          <img className='m-3.5' src={HFLogo} alt="logo" />
